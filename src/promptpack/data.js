...
export const prompts = [
  ...
  },
  {
    ...
    prompt: 'A high-impact, dynamic studio shot of a massive [YOUR PRODUCT HERE: e.g., bright red high-performance brake caliper with drilled carbon-ceramic rotor]. Captured with a Nikon D850 and a 105mm f/2.8 lens. The lighting is exceptionally dramatic, using cool, blue-toned LED panels to create a tech-inspired background, while a sharp, neutral white spotlight perfectly illuminates the vibrant paint and metallic texture of the caliper. High-speed racing aesthetic, pristine studio isolation, 8k resolution.'
  },
  {
    id: 'auto-36',
    categoryId: 'automotive',
    ...
    prompt: 'A mesmerizing, tech-forward product shot of a [YOUR PRODUCT HERE: e.g., sleek carbon fiber side mirror cover for a compact hatchback] floating in a pure, infinite black void. Shot on a Leica SL2-S with a 50mm f/1.4 ASPH lens. The lighting setup uses precisely positioned strip boxes to cast long, elegant highlights that catch the intricate, interwoven geometric pattern of the glossy carbon fiber weave, showcasing its lightweight properties. Hyper-realistic, futuristic automotive design, 8k.'
  },
  {
    id: 'auto-37',
    categoryId: 'automotive',
    ...
    prompt: 'A stunning, aggressive close-up of a [YOUR PRODUCT HERE: e.g., dual titanium exhaust pipe tip] showcasing the beautiful, iridescent blue and purple burnt metal gradient. The product sits on a dark, brushed steel workbench. Captured with a Canon EOS R5 and an RF 100mm f/2.8L Macro. The lighting is intense and directional, using a hard snoot light to make the metallic colors pop violently against the dark, moody background. Tuning culture, raw power, mechanical perfection, 8k resolution.'
  },
  {
    id: 'auto-38',
    categoryId: 'automotive',
    ...
    prompt: 'A dramatic, front-facing macro shot of a [YOUR PRODUCT HERE: e.g., modern LED projector headlight assembly]. The internal daytime running lights form an aggressive, glowing [LIGHT COLOR: e.g., crisp white] signature. Shot with a Fujifilm GFX 100S and a 120mm Macro lens. The lighting is exclusively generated by the headlight itself, surrounded by complete pitch-black darkness, creating an intimidating, predatory aesthetic. The extreme resolution captures the pristine clarity of the glass lens and internal reflectors. 8k, photorealistic.'
  },
  {
    id: 'auto-39',
    categoryId: 'automotive',
  ...
  },
  {
    ...
    prompt: 'An imposing, low-angle product visualization of a [YOUR PRODUCT HERE: e.g., gloss black honeycomb front grille for a sports car] standing alone on a seamless dark grey studio cyclorama. Shot with a RED Monstro 8K VV and a 35mm wide-angle cine lens to exaggerate the aggressive, wide stance of the part. The lighting utilizes a massive overhead light bank to illuminate the complex geometric depth of the honeycomb mesh, casting deep, repeating shadows that emphasize airflow and aerodynamics. 8k, hyper-realistic.'
  },
